...
// =============================================
// Consulta na tabela docente
// =============================================
$comando   = "SELECT id, nome, cpf, data_nascimento, status FROM docente";
...
if ($qtdeRegistros == 0) {
    echo "Nenhum docente foi encontrado.<br>";
    echo "<a href='javascript:history.back();'>Voltar</a>";
} else {
    echo "Quantidade: <b>$qtdeRegistros</b> docente(s) encontrado(s).<br></br>";
