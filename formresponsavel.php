...
<head>
    <meta charset="utf-8"/>
    <title>Formulário Responsável</title>
</head>
<body>

<?php
echo('
<h2>Inclusão de Responsável</h2>
<form method="post" name="formulario" action="responsavel.php">
    ...
    Telefone 1 (*): <input type="text" name="telefone1" size="15" maxlength="15" required><br/>
    Telefone 2: <input type="text" name="telefone2" size="15" maxlength="15"><br/>
